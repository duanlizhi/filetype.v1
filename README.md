...
```bash
go get github.com/duanlizhi/filetype.v1
```
...
- [`github.com/duanlizhi/filetype.v1/types`](https://godoc.org/github.com/h2non/filetype/types)
- [`github.com/duanlizhi/filetype.v1/matchers`](https://godoc.org/github.com/h2non/filetype/matchers)
...
import (
  "fmt"
  "github.com/duanlizhi/filetype.v1"
  "io/ioutil"
)
